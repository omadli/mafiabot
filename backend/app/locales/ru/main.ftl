...
phase-night-start =
    <b>🌚 🌃Ночь:</b> { $round }
    <i>На улицу вышли только смелые и бесстрашные. Утром посчитаем выживших...</i>
...
phase-night-start-2 =
    <b>🌚 🌃Ночь:</b> { $round }
    <i>Город шепчет под луной — кто-то перестал дышать...</i>
phase-night-start-3 =
    <b>🌚 🌃Ночь:</b> { $round }
    <i>Заприте двери — на улице слышны шаги...</i>
phase-night-start-4 =
    <b>🌚 🌃Ночь:</b> { $round }
    <i>Сова бдит, но и она видит не всё...</i>
phase-night-start-5 =
    <b>🌚 🌃Ночь:</b> { $round }
    <i>Звёзды свидетели — город ночью не спит, лишь притворяется.</i>

phase-day-start =
    <b>Доброе утро🌝</b>
    <b>🌄День:</b> { $round }
    Ветер разносит ночные слухи по всему городу..
...
phase-day-start-2 =
    <b>Доброе утро🌝</b>
    <b>🌄День:</b> { $round }
    Солнце высушило кровь, пролитую ночью...
phase-day-start-3 =
    <b>Доброе утро🌝</b>
    <b>🌄День:</b> { $round }
    Город проснулся — но кто-то уже не проснётся.
phase-day-start-4 =
    <b>Доброе утро🌝</b>
    <b>🌄День:</b> { $round }
    Время завтрака, но за столами стало пустее...
phase-day-start-5 =
    <b>Доброе утро🌝</b>
    <b>🌄День:</b> { $round }
    Петух прокричал — время считать.
...
leave-self-hanged = 🪢 { $mention }, не дожидаясь приговора, повесился сам.
...
hanging-cancelled =
    ...
    <i>Народ не пришёл к согласию, голосование переросло в перепалку. Все разошлись по домам...</i>
...
mafia-team-intro =
    🤵🏻 <b>Добро пожаловать в мафиозную команду!</b>

    Вы — <b>{ $role }</b>.
    { $description }

    🕵 <b>Запомните своих сообщников:</b>
    { $roster }

    💬 Теперь каждую ночь можете писать боту, чтобы
    обсудить планы — ваше сообщение получат все
    члены мафии.
...
# Короткие описания ролей — для алерта "Ваша роль" (лимит Telegram ~200
# символов). Полные версии в role-desc-{code}.
role-short-citizen = Особых способностей нет. Участвуйте в обсуждении и вычисляйте мафию.
role-short-detective = Каждую ночь проверяете 1 игрока и узнаёте, мафия он или мирный.
role-short-sergeant = Помощник Комиссара. Если Комиссар погибнет, вы начинаете проверять.
role-short-mayor = Мэр. Ваш голос считается за два.
role-short-doctor = Каждую ночь лечите 1 игрока, защищая от атаки. Себя — только 1 раз.
role-short-hooker = Каждую ночь усыпляете 1 игрока, отменяя его ночное действие.
role-short-hobo = Ночью идёте в гости и видите, кто ещё пришёл к этому игроку.
role-short-lucky = Если мафия нападёт — с 50% удачей вы выживете.
role-short-suicide = Повесили днём — вы победили! Убили ночью — проиграли.
role-short-kamikaze = Если вас повесят, вы заберёте с собой ещё 1 игрока.
role-short-don = Этой ночью вы решаете, кто умрёт. Вы — главарь Мафии.
role-short-mafia = Член мафии. Ночью участвуете в убийстве цели, выбранной Доном.
role-short-lawyer = Каждую ночь защищаете 1 мафиози от проверки Комиссара и от линчевания.
role-short-journalist = Шпион мафии. Ночью узнаёте, является ли игрок Доктором/Бродягой/Жрицей.
role-short-killer = Доктор не может вылечить вашу атаку. Жрица не может вас усыпить.
role-short-maniac = Одиночка-убийца. Победа — остаться последним. Ночью убиваете 1 игрока.
role-short-werewolf = Ночью атакуете игрока и принимаете его роль (Дон→Мафия, Комиссар→Сержант).
role-short-mage = Маг. Дожив до конца — побеждаете один.
role-short-arsonist = Ночью "поджигаете" цели. После 3-й — все они погибают сразу.
role-short-crook = Аферист. Дожив до конца — победа. Можете голосовать от имени другого.
role-short-snitch = Ночью выбираете игрока. Если Комиссар проверит того же — вы победили!
...
role-desc-don =
    Этой ночью <b>вы решаете, кто умрёт</b>. Вы — главарь Мафии.
...
role-desc-killer =
    Самый сильный убийца мафии. <b>Доктор не может вылечить</b> вашу жертву —
    кого вы выбрали, тот умирает. 🛡 Щит и ⛑ Щит от Киллера спасают цель
    от вашей атаки, но 🔫 Винтовка пробивает и эти защиты.
    💃 Жрица не может вас усыпить.
...
sa-notify-diamonds-granted =
    💎 <b>Супер-админ подарил вам { $amount } алмазов!</b>

    Это официальное уведомление от Супер-админа через бот.

sa-notify-premium-granted =
    👑 <b>Вам подарен премиум-статус!</b>

    Срок действия: до <b>{ $expires }</b>.
