...
export function useI18n() {
  ...
  const FLAT_TO_NESTED: Record<string, string> = {
    ...
    "sa-nav-role-configs": "sa.nav.role_configs",
    "sa-nav-emoji-configs": "sa.nav.emoji_configs",
    "sa-nav-players": "sa.nav.players",
    "sa-nav-groups": "sa.nav.groups",
    "sa-nav-system": "sa.nav.system",
    "sa-nav-users": "sa.nav.users",
    "sa-nav-games": "sa.nav.games",
    "sa-nav-audit": "sa.nav.audit",
